...
const StyledTableCell = styled(TableCell)(({ theme }) => ({
  ...
  const rows = [
    createData('1', "PG Soft", "User", 1234567, "Active", 999.00, "2-Jun-2024"),
    createData('2', "PG Soft", "User", 1234567, "Active", 999.00, "2-Jun-2024"),
    createData('3', "PG Soft", "User", 1234567, "Active", 999.00, "2-Jun-2024"),
    ...
    <Box sx={{ gap: 2, display :'flex', flexDirection: 'column', bgcolor:'background.paper'}}>
      ...
      <Table sx={{ minWidth: 700 }} aria-label="customized table">
        ...
        <TableRow>
            ...
            <StyledTableCell align="center" rowSpan={2}>จัดการ</StyledTableCell>
